...
return [
        ...
        'parent_location' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND {#tx_chfbase_domain_model_location}.{#sys_language_uid} IN (-1, 0)'
                    . ' AND {#tx_chfbase_domain_model_location}.{#pid} IN (###CURRENT_PID###, ###SITE:settings.chf.data.page###)',
                'treeConfig' => [
    ...
    'types' => [
        '0' => [
            ...
            --div--;LLL:EXT:chf_base/Resources/Private/Language/locallang.xlf:object.generic.management,--palette--;;isTeaserIsHighlightIsHistoricalIsImaginary,--palette--;;parentLocationParentResource,--palette--;;iriUuid,same_as,
