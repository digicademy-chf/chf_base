...
return [
    'ctrl' => [
        ...
        'versioningWS'             => true,
        'iconfile'                 => 'EXT:chf_base/Resources/Public/Icons/TableFootnote.svg',
        'origUid'                  => 't3_origuid',
        'hideAtCopy'               => true,
    ...
    'types' => [
        '0' => [
            'showitem' => 'text,
            --div--;LLL:EXT:chf_base/Resources/Private/Language/locallang.xlf:object.generic.management,uuid,',
        ],
    ],
];
