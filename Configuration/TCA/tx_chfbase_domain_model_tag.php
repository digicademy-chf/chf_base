...
return [
    ...
    'types' => [
        ...
        'labelTag' => [
            ...
            --div--;LLL:EXT:chf_base/Resources/Private/Language/locallang.xlf:object.generic.usage,asLabelOfAgent,asLabelOfLocation,asLabelOfPeriod,asLabelOfDictionaryEntry,asLabelOfEncyclopediaEntry,asLabelOfBibliographicEntry,asLabelOfVolume,asLabelOfEssay,asLabelOfSingleObject,asLabelOfObjectGroup,asLabelOfFileGroup,',
        ],
        'labelTypeTag' => [
            'showitem' => 'hiddenParentResource,uuidType,codeText,description,sameAs,
