...
return [
    'ctrl' => [
        ...
        'searchFields'             => 'type,forename,surname,corporateName,alternativeName,honorific,occupation,gender,uuid,publicationDate,revisionDate,revisionNumber,editorialNote,importOrigin,import',
        'enablecolumns'            => [
            'disabled' => 'hidden',
            'starttime' => 'starttime',
            'endtime' => 'endtime',
    ...
    'palettes' => [
        ...
        'isTeaserIsHighlightIsContributor' => [
            'showitem' => 'isTeaser,isHighlight,isContributor,',
        ],
